										...
										<tbody class="fw-bold text-gray-600">
											...
											foreach ($products as $row) { ?>
												<tr>
													...
													<td style="text-align: center;">
													<button class="btn btn-primary btn-sm message-toggle" data-bs-toggle="modal" data-bs-target="#message-modal-<?php echo $row['id']; ?>">View Review</button>
													</td>
														...
														<div class="modal-dialog modal-dialog-centered">
															<div class="modal-content">
																<div class="modal-header">
																	<h5 class="modal-title" id="message-modal-<?php echo $row['id']; ?>-label">Review Details</h5>
																...
																<div class="modal-body">
																	...
																	<? $customerId=$row['customer_id'];
																		$r=mysqli_fetch_assoc(mysqli_query($con,"select * from ecommerce_customers where id='$customerId'"));
																		echo "<br>";
																		echo "<strong>Review By</strong>";
																		echo "<br>";
																		echo $email=$r['email'];
																	?>
																</div>
