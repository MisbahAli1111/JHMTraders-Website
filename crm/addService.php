										...
										<div class="row">
											...
											<div class="col-12 mb-10">
												...
												<select class="form-control" name="category">
													<option <? if ($productDeets['category'] == "Plastic") {
																echo "selected";
															} ?> value="Plastic">Plastic</option>
													<option <? if ($productDeets['category'] == "Metallic") {
																echo "selected";
															} ?> value="Metallic">Metallic</option>
													<option <? if ($productDeets['category'] == "Fiber") {
																echo "selected";
															} ?> value="Fiber">Fiber</option>
												</select>
											</div>
											<div class="col-12 mb-10">
													...
													<div class="col-12 mt-10">
														...
														foreach ($productImages as $row) { ?>
															<p class="btn btn-light-success btn-sm" style="margin-right:3px;">
																...
																<a onclick="return confirm('Are you sure you want to delete this image?');" href="?productId=<? echo $productId ?>&removeImage=<? echo $row['id'] ?>" style="margin-left: 10px;color: red;">X</a>
															</p>
														<? } ?>
													</div>
												</div>
